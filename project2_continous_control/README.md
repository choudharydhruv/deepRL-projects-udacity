...
For this project, we were provided two separate versions of the Unity environment:
...
2. Place the file in the  GitHub repository, in the `project2_continous_control` folder, and unzip (or decompress) the file. 
For the multi_agent environment (Option 2), place the unzipped file in the `project2_continous_control/multi_agent` folder.
