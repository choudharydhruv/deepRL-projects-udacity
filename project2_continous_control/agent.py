...
class Agent():
    ...
    def __init__(self, state_size,
        ...
        self.memory = ReplayBuffer(action_size, int(replay_buffer_len), batch_size, random_seed)
    ...
    def learn(self, experiences):
        ...
        actor_loss = -self.critic_local(states, actions_pred).mean() # maximizing policy
        # Minimize the loss
